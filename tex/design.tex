...
\begin{minipage}{\linewidth}
    \centering
        ...
        \captionof{figure}{Light grey, black and light blue}
        \label{fig:bluegrey}
\end{minipage}\\
...
\captionof{figure}{Dark grey, white and orange}
...
\captionof{figure}{Thoughts behind the Choona logo}
\label{fig:logo}
\end{minipage}\\
...
\captionof{figure}{Bonvenocf font\footcite{bonvenocf}}
\label{fig:Bonvenocf}
\end{minipage}\\
...
\captionof{figure}{Welcome screens}
...
\captionof{figure}{Side menu page}
\label{fig:sidemenu}
\end{minipage}\\
...
\captionof{figure}{Playlist page}
\label{fig:playlist}
\end{minipage}\\
...
\captionof{figure}{Now playing page}
...
\captionof{figure}{Activity page}
...
\captionof{figure}{History pages}
